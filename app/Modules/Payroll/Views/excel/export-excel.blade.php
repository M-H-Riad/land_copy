...
@if(isset($data))
    <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    @if(isset($empData->name))
                        <span class="light">{{$empData->bank_account_no}}, {{$empData->pfno}}, {{$empData->grade}} <br/></span>
                        {{$empData->name}} <br/>
                        <span class="light">
                            {{$empData->designation}}
                            @if($empData->designation_status =='CC')
                                - {{$empData->designation_status}}
                            @endif
                        </span>
                    @endif
                </td>
                ...
                <td class="right">
                    ...
                    {{number($row->total_ded)}}
                </td>
                <td class="right">
                    {{number($row->rev_stamp)}}
                    <br/><b> {{number($row->net_payable)}}</b>
                </td>
            </tr>
            <?php
            $row = $row->toArray();
        ...
        <tr class="right">
            ...
            <td class="right">
                {{number($total['vhl_alw'])}}
                <br/>{{number($total['other_alw'])}}
            ...
            <td class="right">
                ...
                {{number($total['total_ded'])}}
            </td>
            <td class="right"><br/>
                {{number($total['rev_stamp'])}}
                <br/><b> {{number($total['net_payable'])}}</b>
            </td>
        </tr>
        </tfoot>
    </table>
