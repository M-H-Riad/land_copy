<html>
<head>
    <title>Department Salary Summery - {{$monthData->title}}</title>
...
{{--                Vhl Allw<br/>--}}
        ...
        $total = [
            ...
            'employees'           => 0, // $row['net_payable'] + $total['net_payable'],
        ];
        $i = 1;
        ?>
        @foreach($data as $row)
