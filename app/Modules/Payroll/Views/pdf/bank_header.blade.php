...
<div style="width:90%;text-align: center; padding-bottom: 4px;float: left">
   <p class="title">DHAKA WATER SUPPLY AND SEWERAGE AUTHORITY</p>
    ...
    <p class="title" style=" text-transform: uppercase"><strong><u>SALARY MONTH {{str_replace('-',' ',$monthData->title).' '}} @if(isset($departmentGroup)) {{trim($departmentGroup->group_name)}} @else WASA & Drainage @endif</u></strong></p>
