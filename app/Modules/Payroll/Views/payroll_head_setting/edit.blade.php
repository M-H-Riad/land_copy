<div id="edit-payroll_head_setting-modal-{{$payroll_head_setting->id}}" class="modal fade" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      {!! Form::model($payroll_head_setting,['url' => 'payroll-head-setting/'.$payroll_head_setting->id, 'method' => 'put']) !!}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Update Payroll Head Setting</h4>
      </div>
      <div class="modal-body">
       ...
       <tr>
         ...
         <td>{!! Form::select('status',['0' => 'Inactive','1' => 'Active'],null, ['class' => 'form-control','placeholder' => 'Select Status']) !!}</td>
       </tr>
     </tbody>
