            ...
            <div class="portlet-body" style="padding: 10px">
                ...
                <div class="col-md-12 side-padding-none">
                    ...
                    <div class="col-md-6" style="margin-bottom:5px;">
                        <a href="{{ URL::to('/deep-tubewell/deep-tubewell-report') }}" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Clear</a>
                        <button class="btn btn-success btn-sm" type="submit"><i class="fa fa-search"></i> Generate Report</button>
                        <a target="_blank" href="{{route('deep-tubewell-report.pdf', \Request::all())}}" class="btn btn-warning btn-sm">
