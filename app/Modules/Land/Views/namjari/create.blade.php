  ...
  <div class="col-md-12">
    <div class="portlet light bordered">
      ...
      <div class="portlet-body">
        {{Form::open(['url'=>'land/namjari','method'=>'post','class'=>"form-horizontal",'role'=>'form','file'=>true])}}
          <div class="form-group col-md-12">
              <label for="title" class="col-md-3 control-label">স্থাপনার নাম <span style="color:red">*</span></label>
              <div class="col-md-5">
              {!! Form::select('land_id', $lands, null, ['class' => 'form-control select2','placeholder' => 'স্থাপনার নাম', 'id' => 'land_id', 'style' => 'width:100%', 'required']) !!}
              </div>
          </div>
          <div class="form-group col-md-12">
          ...
          <div class="form-group col-md-12">
              ...
              <div class="col-md-5">
              {!! Form::select('status', ['0' => 'না','1' => 'হ্যা'],null, ['class' => 'form-control','placeholder' => 'Select Status', 'id' => 'namjari_status','style' => 'width:100%', 'required']) !!}
              </div>
          </div>
          <div id="namjari_details" style="display: none;">
            <div class="form-group col-md-12">
                <label for="jomir_sreny" class="col-md-3 control-label">জমির শ্রেণী<span style="color:red">*</span></label>
                <div class="col-md-5">
                {{ Form::select('jomir_sreny',['0' => 'কৃষি','1' => 'অকৃষি'] ,request('jomir_sreny'), ['class' => 'form-control mask_date', 'id' => 'jomir_sreny','placeholder'=>'জমির শ্রেণী','style' => 'width:100%']) }}
                
                {{ Form::text('jomir_sreny_details',request('jomir_sreny_details'), ['class' => 'form-control', 'id' =>'jomir_sreny_details','placeholder'=>'অকৃষি জমির বিবরণ','style' => 'width:100%, display:none']) }}
                </div>
            </div>
            <div class="form-group col-md-12">
                <label for="namjari_date" class="col-md-3 control-label">নামজারি তারিখ</label>
                <div class="col-md-5">
                {{ Form::date('namjari_date',request('namjari_date'), ['class' => 'form-control', 'id' => 'namjari_date','placeholder'=>'নামজারি তারিখ','style' => 'width:100%']) }}
                </div>
            </div>
            {{-- <div class="form-group col-md-12">
                <label for="purchase_date" class="col-md-3 control-label">প্রাপ্তির তারিখ</label>
                <div class="col-md-5">
                {{ Form::date('purchase_date',request('purchase_date'), ['class' => 'form-control', 'id' => 'purchase_date','placeholder'=>'প্রাপ্তির তারিখ','style' => 'width:100%']) }}
                </div>
            </div> --}}
            <div class="form-group col-md-12">
                <label for="namjari_khotian_no" class="col-md-3 control-label">খতিয়ান নং <span style="color:red">*</span></label>
                <div class="col-md-5">
                    {{ Form::text('namjari_khotian_no', null, ['class' => 'form-control', 'placeholder'=>'খতিয়ান নং', 'id' => 'namjari_khotian_no',]) }}
                </div>
            </div>
            <div class="form-group col-md-12">
                <label for="namjarir_dag_no" class="col-md-3 control-label">দাগ নং<span style="color:red">*</span></label>
                <div class="col-md-5">
                    {{ Form::text('namjarir_dag_no', null, ['class' => 'form-control', 'placeholder'=>'দাগ নং', 'id' => 'namjarir_dag_no',]) }}
                </div>
            </div>
            <div class="form-group col-md-12">
                <label for="oi_dage_mot_jomi" class="col-md-3 control-label">ওই দাগে মোট জমির পরিমান</label>
                <div class="col-md-5">
                    {{ Form::text('oi_dage_mot_jomi', null, ['class' => 'form-control col-md-3', 'placeholder'=>'ওই দাগে মোট জমির পরিমান', 'id' => 'oi_dage_mot_jomi',]) }}
                    
                    {!! Form::select('jomir_unit', ['1' => 'শতাংশ', '2' => 'অযুতাংশ', '3' => 'একর', '4' => 'কাঠা', '5' => 'বিঘা'],null, ['class' => 'form-control col-md-2','placeholder' => 'জমির একক', 'id' => 'jomir_unit','style' => 'width:100%']) !!}
            ...
            {{-- <div class="form-group col-md-12">
                ...
                <div class="col-md-5">
                    {!! Form::text('dager_moddhe_khotianer_ongsho',request('dager_moddhe_khotianer_ongsho'), ['class' => 'form-control','placeholder' => 'দাগের মধ্যে অত্র খতিয়ানের অংশ', 'id' => 'dager_moddhe_khotianer_ongsho','style' => 'width:100%']) !!}
                </div>
            </div>
            <div class="form-group col-md-12">
                ...
                <div class="col-md-5">
                    {{ Form::text('ongsho_onujaie__jomir_poriman', null, ['class' => 'form-control col-md-3', 'placeholder'=>'অংশ অনুযায়ীই জমির পরিমান', 'id' => 'ongsho_onujaie__jomir_poriman',]) }}
                    
                    {!! Form::select('ongsho_onujaie_jomir_akok', ['1' => 'শতাংশ', '2' => 'অযুতাংশ', '3' => 'একর', '4' => 'কাঠা', '5' => 'বিঘা'],null, ['class' => 'form-control col-md-2','placeholder' => 'জমির একক', 'id' => 'ongsho_onujaie_jomir_akok','style' => 'width:100%']) !!}
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-5">
                    {{ Form::text('namjari_jot_no', null, ['class' => 'form-control', 'placeholder'=>'জোত নং', 'id' => 'namjari_jot_no',]) }}
                </div>
            </div>
            <div class="form-group col-md-12">
                <label for="namjari_jl_no" class="col-md-3 control-label">জে এল নং</label>
                <div class="col-md-5">
                    {{ Form::text('namjari_jl_no', null, ['class' => 'form-control', 'placeholder'=>'জে এল নং','id' => 'namjari_jl_no',]) }}
                </div>
            </div>
            <div class="form-group col-md-12">
                <label for="note" class="col-md-3 control-label">মন্তব্য</label>
                <div class="col-md-5">
                    {{ Form::textarea('note', null, ['class' => 'form-control height-20 weight-300', 'placeholder'=>'মন্তব্য','id' => 'note',]) }}
                </div>
            </div>
          </div>
          <hr>
