  ...
  <div class="col-md-12">
    <div class="portlet light bordered">
      ...
      <div class="portlet-body">
        {{Form::open(['url'=>'land/vumi_office/'.$vumiOffice->id,'method'=>'put','class'=>"form-horizontal",'role'=>'form'])}}
          <div class="form-group col-md-12">
              <label for="office_name" class="col-md-3 control-label">ভূমি অফিসের নাম <span style="color:red">*</span></label>
              <div class="col-md-5">
              {!! Form::text('office_name', $vumiOffice->office_name, ['class' => 'form-control','placeholder' => 'ভূমি অফিসের নাম', 'style' => 'width:100%', 'required']) !!}
              </div>
          </div>
          ...
          <div class="form-group col-md-12">
              ...
              <div class="col-md-5">
              {!! Form::text('address', $vumiOffice->address, ['class' => 'form-control','placeholder' => 'ভূমি অফিসের ঠিকানা', 'style' => 'width:100%', 'required']) !!}
              </div>
          </div>
