    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
          <div class="caption font-red-sunglo">
              ...
              <span class="caption-subject bold uppercase">কর সেটআপ পেজ</span>
          </div>
      </div>

      <div class="portlet-body">
        {{Form::open(['url'=>'land/khajna-office','method'=>'post','class'=>"form-horizontal",'role'=>'form','file'=>true])}}
          <div class="form-group col-md-12">
              <label for="title" class="col-md-3 control-label">স্থাপনার নাম <span style="color:red">*</span></label>
              <div class="col-md-5">
              {!! Form::select('land_id', $lands, null, ['class' => 'form-control select2','placeholder' => 'স্থাপনার নাম', 'style' => 'width:100%', 'required']) !!}
              </div>
          </div>
          <div class="form-group col-md-12">
              <label for="khajna_office_id" class="col-md-3 control-label">ভূমি অফিসের নাম <span style="color:red">*</span></label>
              <div class="col-md-5">
              {!! Form::select('khajna_office_id', $khajnaOffices, null, ['class' => 'form-control select2','placeholder' => 'ভূমি অফিসের নাম', 'style' => 'width:100%', 'required']) !!}
              </div>
          </div>
          ...
          <div class="form-group col-md-12">
              <label for="open_year" class="col-md-3 control-label">ওপেনিং কর দাবির সন <span style="color:red">*</span></label>
               <div class="col-md-5">
              <!--{!! Form::text('open_year', null, ['class' => 'form-control','placeholder' => 'ওপেনিং কর দাবির সন', 'style' => 'width:100%', 'required']) !!} -->
          ...
          <div class="form-group col-md-12">
              ...
              <div class="col-md-5">
              {!! Form::text('total_bokeya', null, ['class' => 'form-control','placeholder' => 'বকেয়ার পরিমাণ বাংলায় লিখুন', 'style' => 'width:100%', 'required']) !!}
              </div>
          </div>
