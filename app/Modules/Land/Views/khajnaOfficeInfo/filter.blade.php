<div class="portlet light bordered">
    ...
    <div class="portlet-body" style="padding: 10px">
        ...
        <div class="col-md-12 side-padding-none">
            ...
            <!-- <div class="col-md-3" style="margin-bottom:5px;">
            {!! Form::select('upazila_id', $upazilas, null, ['class' => 'form-control select2', 'id' => 'upazila_id','placeholder' => 'উপজেলার নাম', 'style' => 'width:100%']) !!}
            </div>
            <div class="col-md-3" style="margin-bottom:5px;">
        ...
        <div class="col-md-12 side-padding-none"> -->
            <div class="col-md-6" style="margin-bottom:5px;">
                <a href="{{url('land/khajna-office')}}" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Clear</a>
                <button class="btn btn-success btn-sm" type="submit"><i class="fa fa-search"></i> Search</button>
                <a target="_blank" href="{{route('khajna-office.pdf.download', \Request::all())}}" class="btn btn-warning btn-sm">
                    <i class="fa fa-file-pdf-o"></i> Download PDF
                </a>
                <a target="_blank" href="{{route('khajna-office.export', \Request::all())}}" class=" btn btn-info btn-sm">
