<div id="documents-modal-edit-{{$row->id}}" class="modal fade" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      {!! Form::model($row,['route' => ['land.document.update',$row->id ], 'method' => 'put','files'=>True]) !!}
        ...
        <table class="table table-bordered table-hover dt-responsive" class="nopagination" width="100%">
          <tbody>
            ...
            <tr>
              ...
              <td>{{ Form::select("file_type_id",$fileTypes, null,["class" => "form-control focus_it", 'required']) }}</td>
            </tr>
            <tr>
