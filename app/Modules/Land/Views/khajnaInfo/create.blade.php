  ...
  <div class="col-md-12">
    <div class="portlet light bordered">
      ...
      <div class="portlet-body">
        ...
        {{Form::open(['url'=>'land/khajna-info','method'=>'post','class'=>"form-horizontal",'role'=>'form', 'enctype' => 'multipart/form-data'])}}
          <div class="form-group col-md-12">
              <label for="title" class="col-md-3 control-label">স্থাপনার নাম <span style="color:red">*</span></label>
              <div class="col-md-5">
              {!! Form::select('land_id', $lands, null, ['class' => 'form-control select2', 'id' => 'land_id','placeholder' => 'স্থাপনার নাম', 'style' => 'width:100%', 'required']) !!}
              </div>
          </div>
          <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="col-md-5">
               {{ Form::text('amount', request('amount'), ['class' => 'form-control', 'placeholder'=>'খাজনার পরিমাণ বাংলায় লিখুন','id' => 'note',]) }}
            </div>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="col-md-5">
            {!! Form::date('khajna_date', request('khajna_date'), ['class' => 'form-control','placeholder' => 'খাজনার তারিখ', 'style' => 'width:100%', 'required']) !!}
            </div>
        </div>
          ...
          <div class="form-group col-md-12">
             ...
             <div class="col-md-5">
                {{ Form::textarea('note', request('note'), ['class' => 'form-control height-20 weight-300', 'placeholder'=>'মন্তব্য','id' => 'note',]) }}
             </div>
          </div>
          <div class="form-group col-md-12">
