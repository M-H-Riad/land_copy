<div id="edit-land_propertyType-modal-{{$propertyType->id}}" class="modal fade" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      {!! Form::model($propertyType, ['url' => 'land/propertytype/'.$propertyType->id, 'method' => 'put']) !!}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Update Land Property Type</h4>
      </div>
      <div class="modal-body">
        <table class="table table-bordered table-hover dt-responsive" class="nopagination" width="100%">
          ...
          <tbody>
            <tr>
              <th style="width: 50%;">Property Type Title</th>
