<div id="photo-modal" class="modal fade" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      {!! Form::open(['url' => 'employee-document/upload-photo', 'method' => 'post','files'=>True]) !!}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Picture & Signature</h4>
      </div>
        ...
        <table class="table table-bordered table-hover dt-responsive" class="nopagination" width="100%">
          ...
          <tbody>
            <tr>
              ...
              <td>{{ Form::file("photo",null,["class" => "form-control focus_it"]) }}
              <span style="color:red">Max File Size 1MB</span>
              </td>
            </tr>
            <tr>
              <th width="50%">Signature</th>
              <td>{{ Form::file("signature",null,["class" => "form-control"]) }}
              <span style="color:red">Max File Size 512kb</span>
              </td>
            </tr>
          </tbody>
