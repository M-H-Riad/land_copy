        ...
        <table class="table table-bordered table-hover dt-responsive" class="nopagination" width="100%">
          ...
          <tbody>
            <tr>
              ...
              <td>{{ Form::select('division_id',$division,null, ['class' => 'form-control js-example-basic-single','style' => 'width:100%','id' => 'division_id_p','onchange' => 'get_district("p")']) }}</td>
            </tr>
            <tr>
              <th width="50%">Name Of District</th>
              <td>{{ Form::select('district_id',[],null, ['class' => 'form-control js-example-basic-single' , 'id' => 'district_id_p','style' => 'width:100%','onchange' => 'get_thana("p")']) }}</td>
            </tr>
            <tr>
              <th width="50%">Thana/Upazila</th>
              <td>{{ Form::select('thana_id',[],null, ['class' => 'form-control js-example-basic-single' , 'id' => 'thana_id_p','style' => 'width:100%','onchange' => 'get_post_office("p")']) }}</td>
            </tr>
             <tr>
              <th width="50%">Post Office</th>
              <td>{{ Form::select("post_office",[],null,["class" => "form-control focus_it",'id'=>'post_office_id_p']) }}</td>
            </tr>
            <tr>
