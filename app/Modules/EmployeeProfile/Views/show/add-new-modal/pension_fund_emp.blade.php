<div id="pension-fund-emp-modal-add" class="modal fade" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      {!! Form::open(['url' => 'pension-fund-emp', 'method' => 'post']) !!}
        ...
        <table class="table table-bordered table-hover dt-responsive" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ Form::text('previous_date',null, ['class' => 'form-control mask_date']) }}</td>
            </tr>
            {{-- <tr>
              <th width="50%">Pension Expire Date</th>
              <td>{{ Form::text('expire_date',null, ['class' => 'form-control mask_date']) }}</td>
            </tr> --}}
          {{--   <tr>
