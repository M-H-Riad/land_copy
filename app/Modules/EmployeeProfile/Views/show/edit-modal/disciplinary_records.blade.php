<div id="suspension-modal{{$row->id}}" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::model($row,['url' => url('employee-disciplinary-records',$row->id), 'method' => 'put']) !!}
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="suspension_id" value="{{$row->id}}">
                <table class="table table-bordered table-hover dt-responsive" class="nopagination" width="100%">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Form::text('ref_date',dateFormat($row->ref_date), ['class' => 'form-control mask_date','placeholder' => 'dd/mm/yyyy','required']) }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th style="width: 50%;">Result Reference No.</th>
                            <td>{{ Form::text("result_ref_no",null,["class" => "form-control"]) }}</td>
                        </tr>
                        <tr>
                            <th width="50%">Result Reference Date</th>
                            <td>
                                {{ Form::text('result_ref_date',dateFormat($row->result_ref_date), ['class' => 'form-control mask_date','placeholder' => 'dd/mm/yyyy']) }}
                            </td>
                        </tr>
                        <tr>
                            <th width="50%">Result</th>
                            <td>
                                {{ Form::textarea('result', $row->result, ['class' => 'form-control']) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
