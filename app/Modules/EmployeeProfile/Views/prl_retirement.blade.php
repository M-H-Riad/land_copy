        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body background-gray">
                ...
                <div class="col-md-12 side-padding-none">
                    ...
                    <div class="col-md-1" style="margin-bottom:5px;">
                        {{ Form::select('status', [''=>'Status','PRL'=>'PRL','Retirement'=>'Retirement'], request('status'), ['class' => 'form-control', 'id' => 'status',]) }}
                    </div>
                    ...
                    <div class="col-md-1">
                        <a href="{{url('prl-retirement')}}" class="btn btn-danger filter-btn" style="padding: 5px;width: 100%;"><i class="fa fa-times"></i> Reset</a>
                    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-green">
                    <!-- <i class="icon-settings font-green"></i> -->
                    <span class="caption-subject bold uppercase">PRL & Retirement  - Total - ({{$employeeList->total()}})</span>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        highlight_nav('employee', 'prl-retirement');
