<div id="edit-designation-modal-{{$department->id}}" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        {!! Form::model($department, ['url' => 'department/'.$department->id, 'method' => 'put']) !!}
          ...
          <table class="table table-bordered table-hover dt-responsive" class="nopagination" width="100%">
            ...
            <tbody>
              <tr>
                ...
                <td>{{ Form::text("department_name", $department->department_name, ["class" => "form-control focus_it"]) }}</td>
              </tr>
              <tr>
