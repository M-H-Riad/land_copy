...
class CreateOvertimeDepartmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('overtime_departments', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('overtime_departments');
    }
}
